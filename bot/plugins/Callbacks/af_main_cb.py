...
async def cb_navg(bot, update: CallbackQuery):
    ...
    text=f"<i>⚜️check links at @cinemagenix ⚜️Found</i> <code>{leng}</code> <i>Results For Your Request clichere 👇👇👇:</i> <code>{query}</code>"
...
async def callback_data(bot, update: CallbackQuery):
    ...
    if query_data == "start":
        buttons = [[
            ...
            InlineKeyboardButton('Source Code 🙄', url ='https://github.com/Lallu-lallus/Adv-auto-filter-v3')
        ],[
